...
public class frag9 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_frag20, container, false);
    ...
    private void GetQuestion() {
        ...
        final Call<List<Question>> QuestionList1 = RetrofitClient.getInstance().create(INodeJS.class).QuestionList2();
