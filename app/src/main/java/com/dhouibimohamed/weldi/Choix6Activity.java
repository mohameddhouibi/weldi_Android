...
public class Choix6Activity extends AppCompatActivity {
    private static final String TAG = "ParentActivity1";
    Context mContext = Choix6Activity.this;
    EditText edit_quest;
    EditText edit_opt1;
    EditText edit_opt2;
    EditText edit_opt3;
    ...
    Button addqst;
    INodeJS myAPI;
    String categorie="Cinema";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_choix6);
