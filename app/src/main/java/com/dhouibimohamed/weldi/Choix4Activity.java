...
public class Choix4Activity extends AppCompatActivity {
    private static final String TAG = "ParentActivity1";
    Context mContext = Choix4Activity.this;
    EditText edit_quest;
    EditText edit_opt1;
    EditText edit_opt2;
    EditText edit_opt3;
    ...
    EditText edit_categ;
    Button addqst;
    String categorie="Maths";
    INodeJS myAPI;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_choix4);
