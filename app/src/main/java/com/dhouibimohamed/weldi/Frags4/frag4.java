package com.dhouibimohamed.weldi.Frags4;
...
import com.dhouibimohamed.weldi.Frags3.frag2;
...
public class frag4 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_frag48, container, false);
            ...
            public void onClick(View v) {
                if (rb0.getText() == CorrectAnswer) {
                    ...
                    handler.postDelayed(new Runnable() {
                        @Override
                        public void run() {
                            getActivity().getSupportFragmentManager().beginTransaction().replace(R.id.DisplayFrag, new frag5()).commit();
                        }
                    }, 1000);
                } else {
            ...
            public void onClick(View v) {
                if (rb3.getText() == CorrectAnswer) {
                    ...
                    handler.postDelayed(new Runnable() {
                        @Override
                        public void run() {
                            getActivity().getSupportFragmentManager().beginTransaction().replace(R.id.DisplayFrag, new com.dhouibimohamed.weldi.Frags3.frag2()).commit();
                        }
                    }, 1000);
                } else {
                    vrai.setVisibility(View.INVISIBLE);
    ...
    private void GetQuestion() {
        ...
        final Call<List<Question>> QuestionList2 = RetrofitClient.getInstance().create(INodeJS.class).QuestionList5();
