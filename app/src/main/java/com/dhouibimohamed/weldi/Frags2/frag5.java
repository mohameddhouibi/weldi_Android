...
public class frag5 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view= inflater.inflate(R.layout.fragment_frag27, container, false);
            ...
            public void onClick(View v) {
                if (rb0.getText() == CorrectAnswer) {
                    ...
                    handler.postDelayed(new Runnable() {
                        @Override
                        public void run() {
                            getActivity().getSupportFragmentManager().beginTransaction().replace(R.id.DisplayFrag, new frag6()).commit();
                        }
                    }, 1000);
                } else {
