package com.dhouibimohamed.weldi.Frags2;
...
import com.dhouibimohamed.weldi.Frags1.frag11;
...
public class frag10 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_frag32, container, false);
            ...
            public void onClick(View v) {
                if (rb0.getText() == CorrectAnswer) {
                    ...
                    handler.postDelayed(new Runnable() {
                        @Override
                        public void run() {
                            getActivity().getSupportFragmentManager().beginTransaction().replace(R.id.DisplayFrag, new frag11()).commit();
                        }
                    }, 1000);
                } else {
    ...
    private void GetQuestion() {
        ...
        final Call<List<Question>> QuestionList1 = RetrofitClient.getInstance().create(INodeJS.class).QuestionList3();
