package com.dhouibimohamed.weldi.Frags5;
...
public class frag1 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_frag56, container, false);
            ...
            public void onClick(View v) {
                if (rb0.getText() == CorrectAnswer) {
                    ...
                    handler.postDelayed(new Runnable() {
                        @Override
                        public void run() {
                            getActivity().getSupportFragmentManager().beginTransaction().replace(R.id.DisplayFrag, new com.dhouibimohamed.weldi.Frags5.frag2()).commit();
                        }
                    }, 1000);
                } else {
    ...
    private void GetQuestion() {
        ...
        final Call<List<Question>> QuestionList2 = RetrofitClient.getInstance().create(INodeJS.class).QuestionList6();
